...
function install_apps {
	...
	"./$application_path$striker_folder/striker.py")
		...
		#Install apps
		chmod +x $application_path$striker_folder/striker.py &> /dev/null
...
function pa_gatling_gun {
	...
	echo "DNS Zone Transfer============================================">> $report_path$hosts/$output.txt; 
	curl http://api.hackertarget.com/zonetransfer/?q=$hosts >> $report_path$hosts/$output.txt;echo >> $report_path$hosts/$output.txt;echo >> $report_path$hosts/$output.txt;
